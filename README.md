...
<li><h3 name="correr-parte-2">Correr la parte 2 del proyecto: </h3>
  ...
  <ul>
    ...
    <li>Carpeta <code>graficas_trayectorias</code>: Almacena las gráficas para cada par de partículas con ángulo de incidencia +/- theta0. A continuación, podemos ver dos gráficas: una para un theta0 pequeño y otra para un theta0 grande. Como vemos, entre más aumenta el ángulo de incidencia, más difiere la posición final en x de ambas partículas.</li>
